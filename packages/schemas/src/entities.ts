...
export const CampaignDraftSchema = z.object({
  ...
  campaign_payload: z.object({
    objective: z.enum(['OUTCOME_AWARENESS', 'OUTCOME_TRAFFIC', 'OUTCOME_ENGAGEMENT', 'OUTCOME_LEADS', 'OUTCOME_APP_PROMOTION', 'OUTCOME_SALES', 'SALES', 'LEADS', 'WEBSITE_TRAFFIC', 'BRAND_AWARENESS']).optional(),
    buying_type: z.string().default('AUCTION'),
    campaign_type: z.enum(['SEARCH', 'DISPLAY', 'PERFORMANCE_MAX', 'VIDEO']).optional(),
...
export const TargetingSchema = z.object({
  ...
  keywords: z.array(z.object({ text: z.string(), match_type: z.enum(['EXACT', 'PHRASE', 'BROAD']) })).default([]),
  languages: z.array(z.object({ id: z.string(), name: z.string() })).default([]),
...
export const AdSetDraftSchema = z.object({
  ...
  name: z.string(),
  payload: z.object({
    conversion_location: z.enum(['website', 'app', 'messenger', 'instant_form', 'calls', 'on_ad']).optional(),
...
export const AdDraftSchema = z.object({
  ...
  payload: z.object({
    ...
    format: z.enum(['single_image', 'single_video', 'carousel', 'responsive_search_ad', 'display_ad']).optional(),
