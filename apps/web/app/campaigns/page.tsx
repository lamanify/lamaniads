...
export default function CampaignsPage() {
  ...
  // (Hidden for now until Google Ads connection is established)
      ...
      <main className="flex-1 flex flex-col overflow-hidden">
        <header className="h-14 border-b border-zinc-200 dark:border-zinc-800 flex items-center justify-between px-6 bg-white dark:bg-zinc-950">
          <div className="flex items-center gap-4">
            ...
            {activePlatform !== 'google' && accounts.length > 0 && (
        ...
        <div className="p-8 h-full overflow-y-auto space-y-8 max-w-7xl w-full mx-auto">
          ...
          {activeMode === 'build' ? (
            <div className="space-y-6">
              {activePlatform === 'meta' ? (
                <div className="border border-dashed border-zinc-200 dark:border-zinc-800 rounded-lg p-12 text-center space-y-4">
                  <div className="max-w-md mx-auto space-y-2">
                    <h3 className="text-sm font-semibold">Meta Ads Campaign Builder</h3>
                    <p className="text-xs text-zinc-500 font-medium">Construct and configure your Meta Ads structure.</p>
                  </div>
                  <button 
                ...
                <div className="border border-dashed border-zinc-200 dark:border-zinc-800 rounded-lg p-12 text-center space-y-4">
                  <div className="max-w-md mx-auto space-y-2">
                    <h3 className="text-sm font-semibold">Google Ads Integration Required</h3>
                    <p className="text-xs text-zinc-500">Connect your Google Ads account to build and manage campaigns.</p>
                  </div>
                  <button 
              ...
              {activePlatform !== 'google' && (draftsLoading || drafts.length > 0) && (
